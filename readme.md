# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 447,390 | 🐛 88 | 📅 2026-03-09 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,550 | 🐛 188 | 🌐 Java | 📅 2026-03-20 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,504 | 🐛 171 | 🌐 Java | 📅 2026-03-19 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,693 | 🐛 394 | 🌐 Java | 📅 2026-03-15 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,693 | 🐛 394 | 🌐 Java | 📅 2026-03-15 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,416 | 🐛 166 | 🌐 Java | 📅 2026-03-21 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,523 | 🐛 74 | 🌐 Java | 📅 2026-03-18 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,360 | 🐛 152 | 🌐 Shell | 📅 2026-03-19 - A self-hosted Minecraft server using Docker containers.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,373 | 🐛 119 | 🌐 JavaScript | 📅 2026-02-13 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 881 | 🐛 16 | 🌐 Java | 📅 2026-03-18 - A simple library for communicating with a Minecraft client/server, written in Java.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,980 | 🐛 419 | 🌐 Java | 📅 2026-03-20 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,379 | 🐛 153 | 🌐 TypeScript | 📅 2026-03-19 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 77 | 🐛 5 | 🌐 C# | 📅 2026-03-20 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
