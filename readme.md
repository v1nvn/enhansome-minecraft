# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 468,546 | 🐛 77 | 📅 2026-05-05 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,625 | 🐛 191 | 🌐 Java | 📅 2026-05-04 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,575 | 🐛 154 | 🌐 Java | 📅 2026-05-18 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Custom Skin Loader](https://github.com/xfl03/MCCustomSkinLoader) ⭐ 594 | 🐛 38 | 🌐 Java | 📅 2026-05-21 - Custom Skin Loader for Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,725 | 🐛 409 | 🌐 Java | 📅 2026-05-17 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,439 | 🐛 92 | 🌐 Java | 📅 2026-05-21 - Botania is a tech mod in essence. The theme is natural magic.
* [Railcraft](https://github.com/Railcraft/Railcraft) ⭐ 524 | 🐛 169 | 🌐 Java | 📅 2023-09-20 - Greatly expand and improve the Minecart system in Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,725 | 🐛 409 | 🌐 Java | 📅 2026-05-17 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,559 | 🐛 83 | 🌐 Java | 📅 2026-05-20 - Allows the connection of newer clients to older server versions for Minecraft servers.
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 932 | 🐛 120 | 🌐 Java | 📅 2026-05-21 - Log everything your players do. Literally 1984.
* [WorldGuard](https://github.com/EngineHub/WorldGuard) ⭐ 921 | 🐛 152 | 🌐 Java | 📅 2026-05-20 - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
...
* [Blessing Skin Server](https://github.com/bs-community/blessing-skin-server) ⭐ 1,008 | 🐛 25 | 🌐 PHP | 📅 2026-03-30 - A web application brings your custom skins back in offline Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,717 | 🐛 145 | 🌐 Shell | 📅 2026-05-20 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 1,033 | 🐛 26 | 🌐 Go | 📅 2026-05-14 - A high performance & paralleled Minecraft proxy written in Go.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,393 | 🐛 119 | 🌐 JavaScript | 📅 2026-05-13 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,183 | 🐛 214 | 🌐 Python | 📅 2026-05-15 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,269 | 🐛 415 | 🌐 Java | 📅 2026-05-20 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,629 | 🐛 331 | 🌐 C++ | 📅 2026-05-06 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,427 | 🐛 120 | 🌐 TypeScript | 📅 2026-05-20 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 92 | 🐛 2 | 🌐 C# | 📅 2026-05-20 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
