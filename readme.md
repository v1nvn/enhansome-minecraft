# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,153 | 🐛 68 | 📅 2026-01-28 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,504 | 🐛 179 | 🌐 Java | 📅 2026-01-23 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,403 | 🐛 163 | 🌐 Java | 📅 2026-02-01 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,510 | 🐛 70 | 🌐 Java | 📅 2026-02-05 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,117 | 🐛 151 | 🌐 Shell | 📅 2026-02-07 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 958 | 🐛 28 | 🌐 Go | 📅 2026-02-08 - A high performance & paralleled Minecraft proxy written in Go.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,155 | 🐛 213 | 🌐 Python | 📅 2026-02-04 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,819 | 🐛 389 | 🌐 Java | 📅 2026-02-08 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,586 | 🐛 320 | 🌐 C++ | 📅 2025-11-14 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,343 | 🐛 136 | 🌐 TypeScript | 📅 2026-02-05 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 69 | 🐛 4 | 🌐 C# | 📅 2026-02-05 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
