# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 467,511 | 🐛 76 | 📅 2026-05-05 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,618 | 🐛 191 | 🌐 Java | 📅 2026-05-04 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,578 | 🐛 154 | 🌐 Java | 📅 2026-05-14 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Custom Skin Loader](https://github.com/xfl03/MCCustomSkinLoader) ⭐ 594 | 🐛 39 | 🌐 Java | 📅 2026-03-27 - Custom Skin Loader for Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,720 | 🐛 409 | 🌐 Java | 📅 2026-05-17 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,436 | 🐛 92 | 🌐 Java | 📅 2026-05-17 - Botania is a tech mod in essence. The theme is natural magic.
* [Railcraft](https://github.com/Railcraft/Railcraft) ⭐ 521 | 🐛 169 | 🌐 Java | 📅 2023-09-20 - Greatly expand and improve the Minecart system in Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,720 | 🐛 409 | 🌐 Java | 📅 2026-05-17 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,451 | 🐛 166 | 🌐 Java | 📅 2026-05-10 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,559 | 🐛 81 | 🌐 Java | 📅 2026-05-15 - Allows the connection of newer clients to older server versions for Minecraft servers.
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 930 | 🐛 134 | 🌐 Java | 📅 2026-05-15 - Log everything your players do. Literally 1984.
* [WorldGuard](https://github.com/EngineHub/WorldGuard) ⭐ 921 | 🐛 155 | 🌐 Java | 📅 2026-05-17 - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
* [CraftBook](https://github.com/EngineHub/CraftBook) ⭐ 321 | 🐛 77 | 🌐 Java | 📅 2026-05-08 - CraftBook lets you create magically extending bridges, compact Redstone circuits, complex Minecart mechanics, and much more — all without a client mod and fully customizable by the server.
* [AntiCheatReloaded](https://github.com/Rammelkast/AntiCheatReloaded) ⭐ 109 | 🐛 0 | 🌐 Java | 📅 2025-01-13 - AntiCheatReloaded helps server admins easily identify and block malicious users by monitoring and analyzing the behaviour of their players.
...
* [Blessing Skin Server](https://github.com/bs-community/blessing-skin-server) ⭐ 1,006 | 🐛 25 | 🌐 PHP | 📅 2026-03-30 - A web application brings your custom skins back in offline Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,707 | 🐛 145 | 🌐 Shell | 📅 2026-05-17 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 1,031 | 🐛 26 | 🌐 Go | 📅 2026-05-14 - A high performance & paralleled Minecraft proxy written in Go.
* [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) ⭐ 216 | 🐛 0 | 🌐 Shell | 📅 2026-05-03 - PaperMC server with out of the box Geyser and Floodgate support using docker.
* [minecraft-docker](https://github.com/tywil04/minecraft-docker) ⚠️ Archived - Fork of [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) ⭐ 216 | 🐛 0 | 🌐 Shell | 📅 2026-05-03 that embeds a discord bot for easy starting and stopping of the server.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,392 | 🐛 119 | 🌐 JavaScript | 📅 2026-05-13 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 888 | 🐛 14 | 🌐 Java | 📅 2026-05-12 - A simple library for communicating with a Minecraft client/server, written in Java.
* [CraftLib](https://github.com/zerite/craftlib) ⭐ 102 | 🐛 3 | 🌐 Kotlin | 📅 2022-12-29 - Complete [Kotlin](https://kotlinlang.org) / Java library for wrapping the entire Minecraft codebase, including protocol, NBT, schematics, chat and more.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,180 | 🐛 215 | 🌐 Python | 📅 2026-05-15 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,253 | 🐛 425 | 🌐 Java | 📅 2026-05-15 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,628 | 🐛 329 | 🌐 C++ | 📅 2026-05-06 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,426 | 🐛 128 | 🌐 TypeScript | 📅 2026-05-17 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 93 | 🐛 2 | 🌐 C# | 📅 2026-05-18 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
