# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 447,703 | 🐛 86 | 📅 2026-03-09 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,553 | 🐛 188 | 🌐 Java | 📅 2026-03-20 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,505 | 🐛 162 | 🌐 Java | 📅 2026-03-21 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,418 | 🐛 98 | 🌐 Java | 📅 2026-03-15 - Botania is a tech mod in essence. The theme is natural magic.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,415 | 🐛 166 | 🌐 Java | 📅 2026-03-21 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,525 | 🐛 74 | 🌐 Java | 📅 2026-03-21 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 908 | 🐛 177 | 🌐 Java | 📅 2026-02-27 - Log everything your players do. Literally 1984.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,362 | 🐛 152 | 🌐 Shell | 📅 2026-03-19 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 982 | 🐛 25 | 🌐 Go | 📅 2026-03-19 - A high performance & paralleled Minecraft proxy written in Go.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,374 | 🐛 119 | 🌐 JavaScript | 📅 2026-02-13 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,164 | 🐛 221 | 🌐 Python | 📅 2026-03-20 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,988 | 🐛 417 | 🌐 Java | 📅 2026-03-21 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,600 | 🐛 322 | 🌐 C++ | 📅 2025-11-14 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,380 | 🐛 154 | 🌐 TypeScript | 📅 2026-03-19 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
