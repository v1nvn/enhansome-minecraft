# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 443,830 | 🐛 75 | 📅 2026-03-04 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,544 | 🐛 186 | 🌐 Java | 📅 2026-03-05 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,491 | 🐛 176 | 🌐 Java | 📅 2026-03-07 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,412 | 🐛 163 | 🌐 Java | 📅 2026-03-09 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [WorldGuard](https://github.com/EngineHub/WorldGuard) ⭐ 910 | 🐛 148 | 🌐 Java | 📅 2026-02-07 - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,304 | 🐛 150 | 🌐 Shell | 📅 2026-03-08 - A self-hosted Minecraft server using Docker containers.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,941 | 🐛 420 | 🌐 Java | 📅 2026-03-09 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,367 | 🐛 143 | 🌐 TypeScript | 📅 2026-03-04 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
