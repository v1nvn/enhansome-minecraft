# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,363 | 🐛 59 | 📅 2026-04-02 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,577 | 🐛 192 | 🌐 Java | 📅 2026-04-08 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,537 | 🐛 173 | 🌐 Java | 📅 2026-04-08 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,425 | 🐛 166 | 🌐 Java | 📅 2026-04-08 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,538 | 🐛 80 | 🌐 Java | 📅 2026-04-07 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 911 | 🐛 181 | 🌐 Java | 📅 2026-03-23 - Log everything your players do. Literally 1984.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,465 | 🐛 151 | 🌐 Shell | 📅 2026-04-08 - A self-hosted Minecraft server using Docker containers.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,375 | 🐛 122 | 🌐 JavaScript | 📅 2026-04-01 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,065 | 🐛 402 | 🌐 Java | 📅 2026-04-08 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,385 | 🐛 135 | 🌐 TypeScript | 📅 2026-04-08 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 83 | 🐛 5 | 🌐 C# | 📅 2026-04-09 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
