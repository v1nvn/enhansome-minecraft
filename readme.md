# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,261 | 🐛 69 | 📅 2026-01-28 with stars
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,456 | 🐛 173 | 🌐 Java | 📅 2026-02-11 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,415 | 🐛 98 | 🌐 Java | 📅 2026-02-13 - Botania is a tech mod in essence. The theme is natural magic.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,405 | 🐛 163 | 🌐 Java | 📅 2026-02-01 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,514 | 🐛 71 | 🌐 Java | 📅 2026-02-12 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,141 | 🐛 153 | 🌐 Shell | 📅 2026-02-10 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 960 | 🐛 27 | 🌐 Go | 📅 2026-02-12 - A high performance & paralleled Minecraft proxy written in Go.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,365 | 🐛 117 | 🌐 JavaScript | 📅 2026-02-13 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,840 | 🐛 394 | 🌐 Java | 📅 2026-02-13 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,344 | 🐛 141 | 🌐 TypeScript | 📅 2026-02-13 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
