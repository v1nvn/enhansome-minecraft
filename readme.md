# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 448,898 | 🐛 88 | 📅 2026-03-09 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,563 | 🐛 188 | 🌐 Java | 📅 2026-03-26 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,510 | 🐛 164 | 🌐 Java | 📅 2026-03-25 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Custom Skin Loader](https://github.com/xfl03/MCCustomSkinLoader) ⭐ 581 | 🐛 39 | 🌐 Java | 📅 2026-03-25 - Custom Skin Loader for Minecraft.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,420 | 🐛 167 | 🌐 Java | 📅 2026-03-25 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,532 | 🐛 72 | 🌐 Java | 📅 2026-03-24 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,395 | 🐛 152 | 🌐 Shell | 📅 2026-03-23 - A self-hosted Minecraft server using Docker containers.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,165 | 🐛 219 | 🌐 Python | 📅 2026-03-25 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,007 | 🐛 421 | 🌐 Java | 📅 2026-03-25 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,385 | 🐛 156 | 🌐 TypeScript | 📅 2026-03-19 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
