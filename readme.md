# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,049 | 🐛 69 | 📅 2026-01-28 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,511 | 🐛 180 | 🌐 Java | 📅 2026-02-11 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,456 | 🐛 172 | 🌐 Java | 📅 2026-02-11 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Custom Skin Loader](https://github.com/xfl03/MCCustomSkinLoader) ⭐ 575 | 🐛 39 | 🌐 Java | 📅 2025-12-24 - Custom Skin Loader for Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,676 | 🐛 380 | 🌐 Java | 📅 2026-01-24 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,415 | 🐛 97 | 🌐 Java | 📅 2026-01-31 - Botania is a tech mod in essence. The theme is natural magic.
* [Railcraft](https://github.com/Railcraft/Railcraft) ⭐ 520 | 🐛 168 | 🌐 Java | 📅 2023-09-20 - Greatly expand and improve the Minecart system in Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,676 | 🐛 380 | 🌐 Java | 📅 2026-01-24 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,404 | 🐛 163 | 🌐 Java | 📅 2026-02-01 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,514 | 🐛 70 | 🌐 Java | 📅 2026-02-12 - Allows the connection of newer clients to older server versions for Minecraft servers.
* [WorldGuard](https://github.com/EngineHub/WorldGuard) ⭐ 906 | 🐛 144 | 🌐 Java | 📅 2026-02-07 - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 901 | 🐛 173 | 🌐 Java | 📅 2026-01-22 - Log everything your players do. Literally 1984.
...
* [Blessing Skin Server](https://github.com/bs-community/blessing-skin-server) ⭐ 988 | 🐛 28 | 🌐 PHP | 📅 2026-02-01 - A web application brings your custom skins back in offline Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,138 | 🐛 153 | 🌐 Shell | 📅 2026-02-10 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 959 | 🐛 27 | 🌐 Go | 📅 2026-02-12 - A high performance & paralleled Minecraft proxy written in Go.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,365 | 🐛 119 | 🌐 JavaScript | 📅 2026-02-12 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 879 | 🐛 16 | 🌐 Java | 📅 2026-02-05 - A simple library for communicating with a Minecraft client/server, written in Java.
...
* [Amidst](https://github.com/toolbox4minecraft/amidst) ⭐ 2,255 | 🐛 268 | 🌐 Java | 📅 2025-12-01 - Display an overview of a Minecraft world, without actually creating it.
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,157 | 🐛 212 | 🌐 Python | 📅 2026-02-12 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,840 | 🐛 395 | 🌐 Java | 📅 2026-02-12 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,587 | 🐛 321 | 🌐 C++ | 📅 2025-11-14 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,343 | 🐛 139 | 🌐 TypeScript | 📅 2026-02-12 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 70 | 🐛 4 | 🌐 C# | 📅 2026-02-12 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
