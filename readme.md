# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 454,332 | 🐛 60 | 📅 2026-04-02 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,579 | 🐛 191 | 🌐 Java | 📅 2026-04-10 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,540 | 🐛 178 | 🌐 Java | 📅 2026-04-08 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,424 | 🐛 165 | 🌐 Java | 📅 2026-04-10 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,541 | 🐛 80 | 🌐 Java | 📅 2026-04-10 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 913 | 🐛 182 | 🌐 Java | 📅 2026-03-23 - Log everything your players do. Literally 1984.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,485 | 🐛 148 | 🌐 Shell | 📅 2026-04-12 - A self-hosted Minecraft server using Docker containers.
...
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 882 | 🐛 17 | 🌐 Java | 📅 2026-04-04 - A simple library for communicating with a Minecraft client/server, written in Java.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,168 | 🐛 210 | 🌐 Python | 📅 2026-04-08 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,073 | 🐛 405 | 🌐 Java | 📅 2026-04-11 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,609 | 🐛 324 | 🌐 C++ | 📅 2026-03-29 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,390 | 🐛 138 | 🌐 TypeScript | 📅 2026-04-10 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 84 | 🐛 3 | 🌐 C# | 📅 2026-04-11 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
