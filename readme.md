# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 448,027 | 🐛 88 | 📅 2026-03-09 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,555 | 🐛 194 | 🌐 Java | 📅 2026-03-23 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,506 | 🐛 162 | 🌐 Java | 📅 2026-03-21 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Custom Skin Loader](https://github.com/xfl03/MCCustomSkinLoader) ⭐ 581 | 🐛 39 | 🌐 Java | 📅 2026-03-09 - Custom Skin Loader for Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,693 | 🐛 395 | 🌐 Java | 📅 2026-03-15 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,418 | 🐛 98 | 🌐 Java | 📅 2026-03-22 - Botania is a tech mod in essence. The theme is natural magic.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,693 | 🐛 395 | 🌐 Java | 📅 2026-03-15 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,415 | 🐛 167 | 🌐 Java | 📅 2026-03-21 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,525 | 🐛 72 | 🌐 Java | 📅 2026-03-22 - Allows the connection of newer clients to older server versions for Minecraft servers.
* [WorldGuard](https://github.com/EngineHub/WorldGuard) ⭐ 913 | 🐛 148 | 🌐 Java | 📅 2026-03-16 - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 908 | 🐛 178 | 🌐 Java | 📅 2026-02-27 - Log everything your players do. Literally 1984.
* [CraftBook](https://github.com/EngineHub/CraftBook) ⭐ 320 | 🐛 76 | 🌐 Java | 📅 2026-02-27 - CraftBook lets you create magically extending bridges, compact Redstone circuits, complex Minecart mechanics, and much more — all without a client mod and fully customizable by the server.
...
* [Blessing Skin Server](https://github.com/bs-community/blessing-skin-server) ⭐ 995 | 🐛 25 | 🌐 PHP | 📅 2026-03-09 - A web application brings your custom skins back in offline Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,370 | 🐛 151 | 🌐 Shell | 📅 2026-03-23 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 985 | 🐛 25 | 🌐 Go | 📅 2026-03-19 - A high performance & paralleled Minecraft proxy written in Go.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,375 | 🐛 119 | 🌐 JavaScript | 📅 2026-02-13 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 880 | 🐛 17 | 🌐 Java | 📅 2026-03-18 - A simple library for communicating with a Minecraft client/server, written in Java.
...
* [Amidst](https://github.com/toolbox4minecraft/amidst) ⭐ 2,260 | 🐛 268 | 🌐 Java | 📅 2025-12-01 - Display an overview of a Minecraft world, without actually creating it.
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,164 | 🐛 221 | 🌐 Python | 📅 2026-03-22 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,989 | 🐛 419 | 🌐 Java | 📅 2026-03-22 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,599 | 🐛 322 | 🌐 C++ | 📅 2025-11-14 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,382 | 🐛 155 | 🌐 TypeScript | 📅 2026-03-19 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 77 | 🐛 5 | 🌐 C# | 📅 2026-03-21 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
