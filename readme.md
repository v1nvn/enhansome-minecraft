# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,832 | 🐛 67 | 📅 2026-01-28 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,509 | 🐛 180 | 🌐 Java | 📅 2026-02-11 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,513 | 🐛 70 | 🌐 Java | 📅 2026-02-09 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 901 | 🐛 172 | 🌐 Java | 📅 2026-01-22 - Log everything your players do. Literally 1984.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,134 | 🐛 153 | 🌐 Shell | 📅 2026-02-10 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 959 | 🐛 26 | 🌐 Go | 📅 2026-02-11 - A high performance & paralleled Minecraft proxy written in Go.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,365 | 🐛 119 | 🌐 JavaScript | 📅 2026-02-11 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 878 | 🐛 16 | 🌐 Java | 📅 2026-02-05 - A simple library for communicating with a Minecraft client/server, written in Java.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,157 | 🐛 212 | 🌐 Python | 📅 2026-02-10 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,833 | 🐛 391 | 🌐 Java | 📅 2026-02-11 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,588 | 🐛 321 | 🌐 C++ | 📅 2025-11-14 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,343 | 🐛 138 | 🌐 TypeScript | 📅 2026-02-05 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 69 | 🐛 4 | 🌐 C# | 📅 2026-02-09 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
