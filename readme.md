# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 457,004 | 🐛 65 | 📅 2026-04-19 with stars
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,550 | 🐛 180 | 🌐 Java | 📅 2026-04-17 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,701 | 🐛 401 | 🌐 Java | 📅 2026-04-19 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,701 | 🐛 401 | 🌐 Java | 📅 2026-04-19 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,434 | 🐛 167 | 🌐 Java | 📅 2026-04-19 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,546 | 🐛 81 | 🌐 Java | 📅 2026-04-19 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 919 | 🐛 183 | 🌐 Java | 📅 2026-03-23 - Log everything your players do. Literally 1984.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,528 | 🐛 142 | 🌐 Shell | 📅 2026-04-16 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 1,012 | 🐛 26 | 🌐 Go | 📅 2026-04-08 - A high performance & paralleled Minecraft proxy written in Go.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,381 | 🐛 124 | 🌐 JavaScript | 📅 2026-04-09 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,116 | 🐛 400 | 🌐 Java | 📅 2026-04-19 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,613 | 🐛 323 | 🌐 C++ | 📅 2026-03-29 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,396 | 🐛 140 | 🌐 TypeScript | 📅 2026-04-18 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 89 | 🐛 3 | 🌐 C# | 📅 2026-04-19 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
