# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 445,819 | 🐛 80 | 📅 2026-03-09 with stars
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,521 | 🐛 72 | 🌐 Java | 📅 2026-03-13 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,335 | 🐛 153 | 🌐 Shell | 📅 2026-03-14 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 981 | 🐛 24 | 🌐 Go | 📅 2026-03-13 - A high performance & paralleled Minecraft proxy written in Go.
...
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 881 | 🐛 17 | 🌐 Java | 📅 2026-03-16 - A simple library for communicating with a Minecraft client/server, written in Java.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,163 | 🐛 222 | 🌐 Python | 📅 2026-02-27 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,958 | 🐛 424 | 🌐 Java | 📅 2026-03-14 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,373 | 🐛 149 | 🌐 TypeScript | 📅 2026-03-15 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 74 | 🐛 5 | 🌐 C# | 📅 2026-03-15 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
