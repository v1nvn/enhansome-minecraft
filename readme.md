# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,495 | 🐛 70 | 📅 2026-01-28 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,511 | 🐛 186 | 🌐 Java | 📅 2026-02-11 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,459 | 🐛 173 | 🌐 Java | 📅 2026-02-11 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,415 | 🐛 96 | 🌐 Java | 📅 2026-02-14 - Botania is a tech mod in essence. The theme is natural magic.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,408 | 🐛 163 | 🌐 Java | 📅 2026-02-01 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,513 | 🐛 71 | 🌐 Java | 📅 2026-02-12 - Allows the connection of newer clients to older server versions for Minecraft servers.
* [WorldGuard](https://github.com/EngineHub/WorldGuard) ⭐ 906 | 🐛 145 | 🌐 Java | 📅 2026-02-07 - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 903 | 🐛 173 | 🌐 Java | 📅 2026-01-22 - Log everything your players do. Literally 1984.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,149 | 🐛 154 | 🌐 Shell | 📅 2026-02-14 - A self-hosted Minecraft server using Docker containers.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,841 | 🐛 387 | 🌐 Java | 📅 2026-02-14 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,588 | 🐛 322 | 🌐 C++ | 📅 2025-11-14 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,346 | 🐛 142 | 🌐 TypeScript | 📅 2026-02-13 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 70 | 🐛 4 | 🌐 C# | 📅 2026-02-14 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
