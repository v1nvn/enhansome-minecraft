# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 465,426 | 🐛 73 | 📅 2026-05-05 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,615 | 🐛 191 | 🌐 Java | 📅 2026-05-04 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,565 | 🐛 150 | 🌐 Java | 📅 2026-05-11 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,433 | 🐛 93 | 🌐 Java | 📅 2026-05-11 - Botania is a tech mod in essence. The theme is natural magic.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,556 | 🐛 82 | 🌐 Java | 📅 2026-05-09 - Allows the connection of newer clients to older server versions for Minecraft servers.
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 927 | 🐛 135 | 🌐 Java | 📅 2026-05-11 - Log everything your players do. Literally 1984.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,656 | 🐛 147 | 🌐 Shell | 📅 2026-05-11 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 1,025 | 🐛 28 | 🌐 Go | 📅 2026-05-08 - A high performance & paralleled Minecraft proxy written in Go.
...
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 886 | 🐛 16 | 🌐 Java | 📅 2026-05-11 - A simple library for communicating with a Minecraft client/server, written in Java.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,227 | 🐛 393 | 🌐 Java | 📅 2026-05-09 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,623 | 🐛 326 | 🌐 C++ | 📅 2026-05-06 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,418 | 🐛 134 | 🌐 TypeScript | 📅 2026-05-11 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 94 | 🐛 3 | 🌐 C# | 📅 2026-05-11 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
