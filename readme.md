# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 460,012 | 🐛 67 | 📅 2026-04-19 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,594 | 🐛 191 | 🌐 Java | 📅 2026-04-27 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,553 | 🐛 168 | 🌐 Java | 📅 2026-04-28 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,705 | 🐛 404 | 🌐 Java | 📅 2026-04-28 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,430 | 🐛 97 | 🌐 Java | 📅 2026-04-26 - Botania is a tech mod in essence. The theme is natural magic.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,705 | 🐛 404 | 🌐 Java | 📅 2026-04-28 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,442 | 🐛 165 | 🌐 Java | 📅 2026-04-29 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,584 | 🐛 146 | 🌐 Shell | 📅 2026-04-28 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 1,018 | 🐛 27 | 🌐 Go | 📅 2026-04-28 - A high performance & paralleled Minecraft proxy written in Go.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,389 | 🐛 124 | 🌐 JavaScript | 📅 2026-04-09 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,174 | 🐛 208 | 🌐 Python | 📅 2026-04-14 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,159 | 🐛 379 | 🌐 Java | 📅 2026-04-27 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,401 | 🐛 141 | 🌐 TypeScript | 📅 2026-04-27 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 89 | 🐛 2 | 🌐 C# | 📅 2026-04-26 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
