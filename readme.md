# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 449,197 | 🐛 89 | 📅 2026-03-09 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,566 | 🐛 189 | 🌐 Java | 📅 2026-03-26 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,512 | 🐛 167 | 🌐 Java | 📅 2026-03-25 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Custom Skin Loader](https://github.com/xfl03/MCCustomSkinLoader) ⭐ 583 | 🐛 40 | 🌐 Java | 📅 2026-03-25 - Custom Skin Loader for Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,694 | 🐛 396 | 🌐 Java | 📅 2026-03-15 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,421 | 🐛 96 | 🌐 Java | 📅 2026-03-22 - Botania is a tech mod in essence. The theme is natural magic.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,694 | 🐛 396 | 🌐 Java | 📅 2026-03-15 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [TNTUtils](https://github.com/ljfa-ag/TNTUtils) ⭐ 9 | 🐛 1 | 🌐 Java | 📅 2026-02-21 - More control over explosions in Minecraft.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,421 | 🐛 167 | 🌐 Java | 📅 2026-03-25 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,533 | 🐛 73 | 🌐 Java | 📅 2026-03-24 - Allows the connection of newer clients to older server versions for Minecraft servers.
* [WorldGuard](https://github.com/EngineHub/WorldGuard) ⭐ 914 | 🐛 150 | 🌐 Java | 📅 2026-03-24 - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 911 | 🐛 176 | 🌐 Java | 📅 2026-03-23 - Log everything your players do. Literally 1984.
...
* [Blessing Skin Server](https://github.com/bs-community/blessing-skin-server) ⭐ 997 | 🐛 25 | 🌐 PHP | 📅 2026-03-09 - A web application brings your custom skins back in offline Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,403 | 🐛 154 | 🌐 Shell | 📅 2026-03-26 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 988 | 🐛 25 | 🌐 Go | 📅 2026-03-19 - A high performance & paralleled Minecraft proxy written in Go.
* [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) ⭐ 214 | 🐛 0 | 🌐 Shell | 📅 2026-01-25 - PaperMC server with out of the box Geyser and Floodgate support using docker.
* [minecraft-docker](https://github.com/tywil04/minecraft-docker) ⚠️ Archived - Fork of [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) ⭐ 214 | 🐛 0 | 🌐 Shell | 📅 2026-01-25 that embeds a discord bot for easy starting and stopping of the server.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,376 | 🐛 119 | 🌐 JavaScript | 📅 2026-03-25 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 881 | 🐛 17 | 🌐 Java | 📅 2026-03-18 - A simple library for communicating with a Minecraft client/server, written in Java.
...
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,166 | 🐛 219 | 🌐 Python | 📅 2026-03-26 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,010 | 🐛 418 | 🌐 Java | 📅 2026-03-26 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,602 | 🐛 322 | 🌐 C++ | 📅 2025-11-14 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,386 | 🐛 157 | 🌐 TypeScript | 📅 2026-03-27 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 78 | 🐛 5 | 🌐 C# | 📅 2026-03-26 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
