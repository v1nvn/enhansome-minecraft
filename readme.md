# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,720 | 🐛 71 | 📅 2026-01-28 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,511 | 🐛 185 | 🌐 Java | 📅 2026-02-16 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,460 | 🐛 174 | 🌐 Java | 📅 2026-02-11 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,415 | 🐛 97 | 🌐 Java | 📅 2026-02-14 - Botania is a tech mod in essence. The theme is natural magic.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,409 | 🐛 163 | 🌐 Java | 📅 2026-02-01 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,156 | 🐛 157 | 🌐 Shell | 📅 2026-02-15 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 963 | 🐛 27 | 🌐 Go | 📅 2026-02-12 - A high performance & paralleled Minecraft proxy written in Go.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,843 | 🐛 382 | 🌐 Java | 📅 2026-02-15 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,346 | 🐛 143 | 🌐 TypeScript | 📅 2026-02-16 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
