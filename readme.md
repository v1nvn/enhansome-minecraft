# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,920 | 🐛 71 | 📅 2026-01-28 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,512 | 🐛 186 | 🌐 Java | 📅 2026-02-16 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,461 | 🐛 176 | 🌐 Java | 📅 2026-02-11 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Custom Skin Loader](https://github.com/xfl03/MCCustomSkinLoader) ⭐ 576 | 🐛 39 | 🌐 Java | 📅 2025-12-24 - Custom Skin Loader for Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,675 | 🐛 380 | 🌐 Java | 📅 2026-01-24 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,415 | 🐛 99 | 🌐 Java | 📅 2026-02-14 - Botania is a tech mod in essence. The theme is natural magic.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,675 | 🐛 380 | 🌐 Java | 📅 2026-01-24 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [TNTUtils](https://github.com/ljfa-ag/TNTUtils) ⭐ 9 | 🐛 1 | 🌐 Java | 📅 2026-01-16 - More control over explosions in Minecraft.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,408 | 🐛 165 | 🌐 Java | 📅 2026-02-16 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,515 | 🐛 71 | 🌐 Java | 📅 2026-02-12 - Allows the connection of newer clients to older server versions for Minecraft servers.
* [WorldGuard](https://github.com/EngineHub/WorldGuard) ⭐ 905 | 🐛 145 | 🌐 Java | 📅 2026-02-07 - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 903 | 🐛 174 | 🌐 Java | 📅 2026-01-22 - Log everything your players do. Literally 1984.
* [CraftBook](https://github.com/EngineHub/CraftBook) ⭐ 320 | 🐛 76 | 🌐 Java | 📅 2026-01-13 - CraftBook lets you create magically extending bridges, compact Redstone circuits, complex Minecart mechanics, and much more — all without a client mod and fully customizable by the server.
* [AntiCheatReloaded](https://github.com/Rammelkast/AntiCheatReloaded) ⭐ 106 | 🐛 0 | 🌐 Java | 📅 2025-01-13 - AntiCheatReloaded helps server admins easily identify and block malicious users by monitoring and analyzing the behaviour of their players.
...
* [Blessing Skin Server](https://github.com/bs-community/blessing-skin-server) ⭐ 989 | 🐛 28 | 🌐 PHP | 📅 2026-02-01 - A web application brings your custom skins back in offline Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,166 | 🐛 154 | 🌐 Shell | 📅 2026-02-16 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 965 | 🐛 27 | 🌐 Go | 📅 2026-02-12 - A high performance & paralleled Minecraft proxy written in Go.
* [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) ⭐ 212 | 🐛 0 | 🌐 Shell | 📅 2026-01-25 - PaperMC server with out of the box Geyser and Floodgate support using docker.
* [minecraft-docker](https://github.com/tywil04/minecraft-docker) ⚠️ Archived - Fork of [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) ⭐ 212 | 🐛 0 | 🌐 Shell | 📅 2026-01-25 that embeds a discord bot for easy starting and stopping of the server.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,366 | 🐛 117 | 🌐 JavaScript | 📅 2026-02-13 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 879 | 🐛 17 | 🌐 Java | 📅 2026-02-17 - A simple library for communicating with a Minecraft client/server, written in Java.
* [CraftLib](https://github.com/zerite/craftlib) ⭐ 99 | 🐛 3 | 🌐 Kotlin | 📅 2022-12-29 - Complete [Kotlin](https://kotlinlang.org) / Java library for wrapping the entire Minecraft codebase, including protocol, NBT, schematics, chat and more.
...
* [Amidst](https://github.com/toolbox4minecraft/amidst) ⭐ 2,256 | 🐛 268 | 🌐 Java | 📅 2025-12-01 - Display an overview of a Minecraft world, without actually creating it.
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,158 | 🐛 212 | 🌐 Python | 📅 2026-02-16 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,846 | 🐛 386 | 🌐 Java | 📅 2026-02-15 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,587 | 🐛 322 | 🌐 C++ | 📅 2025-11-14 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,346 | 🐛 140 | 🌐 TypeScript | 📅 2026-02-16 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 70 | 🐛 4 | 🌐 C# | 📅 2026-02-15 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
...
* [SchematicWebViewer](https://github.com/EngineHub/SchematicWebViewer) ⭐ 74 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-22 - A JavaScript/TypeScript library for rendering and viewing Minecraft schematic files on the web.
