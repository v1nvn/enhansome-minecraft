# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 445,548 | 🐛 81 | 📅 2026-03-09 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,551 | 🐛 186 | 🌐 Java | 📅 2026-03-05 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,500 | 🐛 178 | 🌐 Java | 📅 2026-03-10 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,328 | 🐛 153 | 🌐 Shell | 📅 2026-03-14 - A self-hosted Minecraft server using Docker containers.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 8,955 | 🐛 419 | 🌐 Java | 📅 2026-03-14 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,372 | 🐛 148 | 🌐 TypeScript | 📅 2026-03-14 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 73 | 🐛 5 | 🌐 C# | 📅 2026-03-15 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
