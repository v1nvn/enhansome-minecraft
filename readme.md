# Awesome Minecraft [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 450,945 | 🐛 65 | 📅 2026-04-01 with stars
...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,572 | 🐛 191 | 🌐 Java | 📅 2026-04-01 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,534 | 🐛 89 | 🌐 Java | 📅 2026-04-01 - Allows the connection of newer clients to older server versions for Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 13,434 | 🐛 150 | 🌐 Shell | 📅 2026-03-31 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 990 | 🐛 24 | 🌐 Go | 📅 2026-04-01 - A high performance & paralleled Minecraft proxy written in Go.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 9,035 | 🐛 412 | 🌐 Java | 📅 2026-04-01 - A powered Minecraft launcher that supports a lot of features.
...
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,385 | 🐛 153 | 🌐 TypeScript | 📅 2026-03-30 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 81 | 🐛 5 | 🌐 C# | 📅 2026-04-01 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
